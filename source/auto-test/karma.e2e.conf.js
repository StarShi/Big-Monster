...
module.exports = function (config) {
    config.set({
        ...
        plugins:["karma-mocha","karma-chai","karma-chrome-launcher","karma-coverage","karma-sourcemap-loader","karma-webpack","karma-coverage-istanbul-reporter","karma-nightmare"],
        // 需要加载到浏览器的文件列表
        files: [
            "*/*.js"
        ],
